...
class Network { /*!<This class will pointers on object of another class (Neuron) as attribute*/ 
	...
	std::string filename; /*!<Name of the file where the time of spikes will be saved. */
