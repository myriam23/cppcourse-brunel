...
{	
	...
	int v =  (eta_* spike_potential_)/(0.1 * tau_); //not static otherwise I cannot simulate the 4 experiences simultaneously 
	std::poisson_distribution<> poisson(v*time_increment_); //not static otherwise I cannot simulate the 4 experiences simultaneously 
